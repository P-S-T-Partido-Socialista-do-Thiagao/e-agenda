...
public class RepositorioCompromissoEmSql : RepositorioBaseEmSql<Compromisso>, IRepositorioCompromisso
{
    ...
    protected override void ConfigurarParametrosRegistro(Compromisso compromisso, IDbCommand comando)
    {
        ...
        comando.AdicionarParametro("DATA", compromisso.DataDeOcorrencia);
        comando.AdicionarParametro("HORAINICIO", compromisso.HoraDeInicio.Ticks);
        comando.AdicionarParametro("HORATERMINO", compromisso.HoraDeTermino.Ticks);
        comando.AdicionarParametro("TIPO", (compromisso.TipoCompromisso));
