...
public class RepositorioCompromissoEmSql : IRepositorioCompromisso
{
    ...
    private Compromisso ConverterParaCompromisso(SqlDataReader leitorCompromisso)
    {
        ...
        var compromisso = new Compromisso(
            ...
            horaInicio,
            horaTermino,
            Convert.ToString(leitorCompromisso["TIPO"]),
    ...
    private void ConfigurarParametrosCompromisso(Compromisso compromisso, SqlCommand comando)
    {
        ...
        comando.Parameters.AddWithValue("DATA", compromisso.DataDeOcorrencia);
        comando.Parameters.AddWithValue("HORAINICIO", compromisso.HoraDeInicio.Ticks);
        comando.Parameters.AddWithValue("HORATERMINO", compromisso.HoraDeTermino.Ticks);

        comando.Parameters.AddWithValue("TIPO", compromisso.TipoCompromisso);
